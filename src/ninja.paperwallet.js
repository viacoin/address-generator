ninja.wallets.paperwallet = {
	...
	templateArtisticHtml: function (i) {
		...
		if (ninja.wallets.paperwallet.encrypt) {
			...
			image = 'data:image/png;base64,0000000=';
		}
		else {
			image = 'data:image/png;base64,0000000=';
		...
		//"<iframe src='bitcoin-wallet-01.svg' id='papersvg" + i + "' class='papersvg' ></iframe>" +
								...
								"<div class='xbtcaddress' id='xbtcaddress" + i + "'></div>" +
								"<div class='x" + keyelement + "' id='x" + keyelement + i + "'></div>" +
							"</div>";
		return walletHtml;
	},
	...
	showArtisticWallet: function (idPostFix, bitcoinAddress, privateKey) {
		...
		document.getElementById("btcaddress" + idPostFix).innerHTML = bitcoinAddress;
		document.getElementById("xbtcaddress" + idPostFix).innerHTML = 'Address: ' + bitcoinAddress;
		...
		if (ninja.wallets.paperwallet.encrypt) {
			...
			document.getElementById("xbtcencryptedkey" + idPostFix).innerHTML = 'Private key: ' +privateKey.slice(0, half) + '<br />' + privateKey.slice(half);
		}
		else {
			document.getElementById("btcprivwif" + idPostFix).innerHTML = privateKey;
			document.getElementById("xbtcprivwif" + idPostFix).innerHTML = 'Private key: ' + privateKey;
		}
